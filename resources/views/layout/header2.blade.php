<header class="site-header">
    <div class="site-header__top shop-details">
    ...
    <div class="site-header__nav shop-details flex-center" id="header_nav">
        <div class="container flex-center-between">
            ...
            <div class="other flex-center">
                ...
                <a href="cart" type="button" class="other-cart">
    ...
    <div class="site-header__slide">
        <div class="container">
            <ul class=" categories " id="cate_slide_header">
